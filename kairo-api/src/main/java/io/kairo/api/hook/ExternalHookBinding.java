...
/**
 * Binds a {@link HookPhase} to an {@link ExternalHookConfig}, representing a single external hook
 * registration parsed from settings.
 *
 * @param phase the lifecycle phase this hook fires on
