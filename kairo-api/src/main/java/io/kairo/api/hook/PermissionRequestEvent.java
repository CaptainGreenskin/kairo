...
/**
 * Event fired when a permission dialog appears (tool needs user approval).
 *
 * @param sessionId the current session identifier
 * @param toolName the tool requesting permission
 * @param toolInput the tool's input arguments
 * @param reason why the tool requires approval
 */
@Experimental("Hook phase added in v0.11")
public record PermissionRequestEvent(
        String sessionId, String toolName, Map<String, Object> toolInput, String reason)
