...
public enum ResourceAction {
    ...
    ALLOW,
    /** Constraint violated but continue with warning. */
    WARN_CONTINUE,
    /** Constraint violated — complete current iteration then exit gracefully. */
    GRACEFUL_EXIT,
    /** Constraint critically violated — stop immediately. */
    EMERGENCY_STOP
}
