...
![Claude Code: Where the Code Lives](../../public/images/ata/claude-code-98-percent.png)
...
flowchart TD
    subgraph Agent困难六维度
        A[不可逆的副作用<br/>写文件/执行命令] --- B[上下文的饥渴<br/>10-50x 对话Agent]
        B --- C[隐形的依赖图<br/>修改传播不可见]
        C --- D[验证的死亡螺旋<br/>修复→验证→新问题]
        D --- E[长程一致性<br/>50步跨度的语义一致]
        E --- F[权限悖论<br/>有用=危险]
        F --- A
    end
```
...
![Operating System ↔ Agent OS](../../public/images/ata/os-agent-isomorphism.png)
