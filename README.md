...
- [Claude Code](https://docs.anthropic.com/en/docs/claude-code) (Anthropic) — Kairo's permission guard model and context engineering strategies were inspired by publicly documented design patterns from Anthropic's Claude Code.
